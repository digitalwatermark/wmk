...
C_anawin = analysis_window();                      % checked
[kk, ii] = meshgrid(0:63, 0:31);
M_anamat = cos((2*ii+1).*(kk-16)*pi/64);       % 32-by-64

D_synwin = synthesis_window();                     % checked
[kk, ii] = meshgrid(0:31, 0:63);
N_synmat = cos((2*kk+1).*(ii+16)*pi/64);       % 64-by-32; checked
