...
% Threshold in quiet+Contribution of the tonal component+Contribution of the noise components
if ~isempty(LTt)
    temp = 10.^(LTq(:).'/10)+sum(10.^(LTt/10),1)+sum(10.^(LTn/10),1);
else
    temp = 10.^(LTq(:).'/10)+sum(10.^(LTn/10),1);
end
